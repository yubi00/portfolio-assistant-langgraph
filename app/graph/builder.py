...
def build_portfolio_graph(
    ...
    builder.add_node(NodeName.GENERATE_SUGGESTIONS, nodes.generate_suggestions)
    ...
    builder.add_edge(NodeName.GENERATE_ANSWER, NodeName.GENERATE_SUGGESTIONS)
    builder.add_edge(NodeName.GENERATE_SUGGESTIONS, NodeName.SAVE_MEMORY)

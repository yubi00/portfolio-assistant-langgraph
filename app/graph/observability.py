...
NODE_LABELS = {
    ...
    NodeName.CHECK_AMBIGUITY: "04 ambiguity",
    NodeName.PLAN_RETRIEVAL: "05 plan",
    NodeName.RETRIEVE_PROJECTS: "06 retrieve:projects",
    NodeName.RETRIEVE_RESUME: "06 retrieve:resume",
    NodeName.RETRIEVE_DOCS: "06 retrieve:docs",
    NodeName.MERGE_NORMALIZE_CONTEXT: "07 merge",
    NodeName.GENERATE_ANSWER: "08 answer",
    NodeName.CLARIFICATION_RESPONSE: "08 clarify",
    NodeName.FRIENDLY_RESPONSE: "08 redirect",
    NodeName.SAVE_MEMORY: "09 memory",
}
